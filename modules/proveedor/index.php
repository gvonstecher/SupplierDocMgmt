...
$template_path = $modules_config['proveedor']['path'] . 'templates/';
...
switch($proveedor_subsection){
	...
	case 'edit': // Edición y/o nueva promocion
		...
		require $site_config['modules'] .$modules_config['proveedor']['path'] . 'proveedor_edit.php';
	break;
	...
	default :
		...
		$js_files[] = $site_config['modules'] .$modules_config['proveedor']['path'] . 'templates/js/proveedor_main.js';

		require $site_config['modules'] . $modules_config['proveedor']['path'] . 'proveedor_main.php';
	break;
