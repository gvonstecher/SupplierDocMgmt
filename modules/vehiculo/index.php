...
$template_path = $modules_config['vehiculo']['path'] . 'templates/';
...
switch($proveedor_subsection){
	...
	default: 
		...
		$js_files[] = $site_config['modules'] .$modules_config['vehiculo']['path'] . 'templates/js/vehiculo_edit.js';
		...
		require $site_config['modules'] .$modules_config['vehiculo']['path'] . 'vehiculo_edit.php';
	break;
